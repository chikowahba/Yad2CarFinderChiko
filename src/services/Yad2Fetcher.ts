...
export class Yad2Fetcher {
  ...
  private proxies: string[] = ['203.243.63.16:80',
    '3.24.58.156:3128',
    '95.217.104.21:24815',
    '103.151.41.7:80',
    '190.113.40.202:999',
  ...
  public async fetchListings(): Promise<Yad2Listing[]> {
    try {
      ...
      console.log(`Fetching from: ${this.baseUrl} with User-Agent: ${userAgent.substring(0, 20)}...`);
      if (proxyUrl) console.log(`Using proxy: ${proxyUrl.split('@')[1] || '[secured]'}`);
